...
export default function Register() {
    ...
    const handleFacebookLogin = (facebookData) => {
        // Qui puoi implementare la logica per gestire i dati restituiti dal login con Facebook
        console.log(facebookData);

        // Aggiungi la tua logica di gestione dei dati di accesso tramite Facebook
    };
